        ...
        <div className="relative flex flex-col items-center justify-center w-full"
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white pt-12">
                <div className="bg-[#3d3d3d36] backdrop-blur-[2px] border border-white border-opacity-10 rounded-full flex p-1 space-x-4 mb-2">
                    <button className="bg-[#3d3d3d36] backdrop-blur-[2px] border border-white border-opacity-10 px-6 text-[26px] rounded-full">
                        Desenvolvedor Front-End.
                    </button>
                    <button className="px-6 text-[26px] bg-none rounded-full">
                        UI Designer
                    </button>
                </div>
                <h1 className="font-inter text-[85px] font-bold text-center leading-tight">
                    <span className='text-[#0086B0]'>Transformando conceitos</span> em <br /> experiências de usuários
                </h1>
                <p className="text-[30px] font-semibold mt-4 text-center">
                    Olá, sou Victor Bravim, desenvolvedor <span className='text-[#0086B0]'>Front-End.</span>
                </p>
                <div className="mt-8 space-x-4">
                    <button className="text-[26px] font-bold px-12 py-1.5 bg-gradient-to-b from-[#8c8c8c25] to-[#3d3d3d36] backdrop-blur-[4px] border border-white border-opacity-10 rounded-full">Contato</button>
                    <button className="text-[26px] font-bold px-8 py-1.5 bg-gradient-to-b from-[#8c8c8c25] to-[#3d3d3d36] backdrop-blur-[4px] border border-white border-opacity-10 rounded-full">Orçamento</button>
                </div>
                <div className="grid gap-4 mt-48 w-full px-40">
